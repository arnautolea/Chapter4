...
public class Exercise0431 {

	public static void main(String[] args) {
		
		int num, count = 1, decimal = 0, remainder;
		
	Scanner input = new Scanner(System.in);
	
		while(true) {	 
			System.out.print("Entre a binary number(containing only 0s and 1s): ");
			num = input.nextInt();
			
				if (String.valueOf(num).matches("[01]+")){
	
					while(num != 0) {
						remainder = num % 10;
						decimal = decimal + remainder * count;
						count *= 2;
						num = num / 10;
					}//while
